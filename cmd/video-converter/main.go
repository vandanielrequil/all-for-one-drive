...
func main() {
	if err := run(); err != nil {
		fmt.Fprintf(os.Stderr, "video-converter: %v\n", err)
		os.Exit(1)
	}
}
...
func run() error {
	...
	converter, err := videoconverter.New(globalConfig.VideoConverter)
	if err != nil {
...
func printProgress(progress videoconverter.Progress) {
